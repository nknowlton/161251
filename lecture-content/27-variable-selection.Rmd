...
So why not just put everything into the model? Because there are two ways to get this wrong.
...
For now, the idea is enough. We will actually use cross-validation in Lecture 28.
