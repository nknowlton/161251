...
Use this as the default lab architecture.
...
At every point, a student should be able to answer: "Am I watching, discussing, or doing?"
...
If prose could plausibly be read as either an instruction or an explanation, rewrite it.
...
Within a section, use the default sequence:

**question -> demonstration -> what to look for -> discuss -> worked interpretation -> your turn**
...
Write in a direct, conversational lecturer voice. Use New Zealand spelling.
