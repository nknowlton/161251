# Linear Models with One Factor{#OneWayModels1}

[In class version](https://R-Resources.massey.ac.nz/161251/Lectures/Lecture19.html)
...
Another common situation is where the explanatory variables are
    categorical variables, or what we will often call **factors**.
...
```{r getCaffeineData, eval=-1, echo=-2}
...
Caffeine.lm |> model.matrix() |> knitr::kable()
```
