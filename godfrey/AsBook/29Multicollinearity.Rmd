# Multicollinearity and Ridge Regression{#Multicollinearity}

[In class version](https://R-Resources.massey.ac.nz/161251/Lectures/Lecture29.html)
...
This model may still be useful for prediction, but the individual weather coefficients should be interpreted cautiously. The reason is not that weather is irrelevant. The reason is that the weather predictors overlap.
