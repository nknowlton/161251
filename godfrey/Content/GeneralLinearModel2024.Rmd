...
```{r Samara model matrix}
Samara.lm |> model.matrix()  |> kable()
Samara.lm2 |> model.matrix() |> kable()
...
Two different parameterisations of the same model will have different coefficients in the `summary()` output. They will have to have the same number of coefficients though.
