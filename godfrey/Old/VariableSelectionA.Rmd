...
To understand the implications, we simulate
	two scenarios. 
...
```{r } 
sigmas = c(summary(lm1)$sigma,summary(lm2)$sigma,summary(lm3)$sigma,summary(lm4)$sigma,summary(lm5)$sigma,summary(lm6)$sigma )
adjR2s = c(summary(lm1)$adj.r.squared,summary(lm2)$adj.r.squared,summary(lm3)$adj.r.squared,summary(lm4)$adj.r.squared,summary(lm5)$adj.r.squared,summary(lm6)$adj.r.squared)
R2preds = c(pred_r_squared(lm1),pred_r_squared(lm2),pred_r_squared(lm3),pred_r_squared(lm4),pred_r_squared(lm5),pred_r_squared(lm6))
