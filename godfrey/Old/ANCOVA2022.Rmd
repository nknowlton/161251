...
head(Retail)
plot(Profit ~ RtailSpc, pch=Arrngmt, col= Arrngmt, data=Retail)
```
...
MultiPlot(data.frame(bedrooms,rent, as.factor(bathrooms)))
...
head(NSrent)
#fix MultiPlot(data.frame(bedrooms,rent, as.factor(bathrooms)))
