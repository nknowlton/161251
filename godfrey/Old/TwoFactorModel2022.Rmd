...
Let's first fit a two-way model with `Mother` variable first, and `Rat` variable second. 
...
Now we fit the model with `Rat` variable first, and `Mother` variable second. 
